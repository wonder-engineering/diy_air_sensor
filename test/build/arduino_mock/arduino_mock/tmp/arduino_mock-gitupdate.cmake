...
# yet).
execute_process(
  COMMAND "/opt/facebook/bin/git" rev-list --max-count=1 "${git_tag}"
  WORKING_DIRECTORY "/Users/bmleedy/PollutionSensor/gas_sensor/test/build/arduino_mock/arduino_mock/src/arduino_mock"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/wjszlachta/arduino-mock.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      execute_process(
        COMMAND "/opt/facebook/bin/git" checkout "${git_remote}/${git_tag}"
        WORKING_DIRECTORY "/Users/bmleedy/PollutionSensor/gas_sensor/test/build/arduino_mock/arduino_mock/src/arduino_mock"
        RESULT_VARIABLE error_code
        )
      if(error_code)
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/bmleedy/PollutionSensor/gas_sensor/test/build/arduino_mock/arduino_mock/src/arduino_mock'."
        ...
        execute_process(
          COMMAND "/opt/facebook/bin/git" tag -a
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/bmleedy/PollutionSensor/gas_sensor/test/build/arduino_mock/arduino_mock/src/arduino_mock'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
    ...
    execute_process(
      COMMAND "/opt/facebook/bin/git" checkout "${git_tag}"
      WORKING_DIRECTORY "/Users/bmleedy/PollutionSensor/gas_sensor/test/build/arduino_mock/arduino_mock/src/arduino_mock"
      RESULT_VARIABLE error_code
      )
    if(error_code)
